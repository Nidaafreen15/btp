...
// 	return ControllerExtension.extend('department.departmentapp.ext.controller.Listcontroller', {
// 		// this section allows to extend lifecycle hooks or hooks provided by Fiori elements
// 		override: {
// 			/**
//              * Called when a controller is instantiated and its View controls (if available) are already created.
//              * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
//              * @memberOf department.departmentapp.ext.controller.Listcontroller
//              */
// 			onInit: function () {
...
//                         var filter_bar = this.getView().mAggregations.con
//                         tent[0].mAggregations.header.mAggregations.content[0].mAggregations.items[0];
//                         if (filter_bar) {
...
sap.ui.define(['sap/ui/core/mvc/ControllerExtension'], function (ControllerExtension) {
	...
	var useremail = 'mailto:nida.afreen@peolsolutions.com';
     var useremail;
	return ControllerExtension.extend('department.departmentapp.ext.controller.Listcontroller',{
		// this section allows to extend lifecycle hooks or hooks provided by Fiori elements
		override: {
